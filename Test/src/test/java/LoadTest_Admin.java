...
public class LoadTest_Admin {
    ...
    @Test
    public void testLoginforuserLoad() throws InterruptedException {
    ...
    @Test
    public void testAddPromotionforflightLoad() throws InterruptedException {
    ...
    @Test
    public void testFetchAllRefunds() throws InterruptedException {
        ExecutorService executorService = Executors.newFixedThreadPool(NUM_THREADS);
        List<Future<Void>> futures = new ArrayList<>();
        Object lock = new Object();
    ...
    @Test
    public void testPostRefunds() throws InterruptedException {
        // Register a user
    ...
    @Test
    public void testUpdateRefundStatusforadmin() throws InterruptedException {
        // Ensure that the token is available from the login step
        if (tokens.isEmpty()) {
            System.err.println("No tokens found. Please run the login test first.");
            return;
